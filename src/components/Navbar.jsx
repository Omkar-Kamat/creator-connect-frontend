...
const style = {
    nav: "bg-black text-white border-b border-gray-800",

    container: "max-w-6xl mx-auto px-4 py-3 flex justify-between items-center",

    logo: "text-lg sm:text-xl md:text-2xl font-bold text-white hover:text-gray-300 transition",

    desktopMenu: "hidden md:flex items-center gap-6",

    mobileButton: "md:hidden text-gray-300 hover:text-white",
    ...
    secondaryLink: "text-gray-300 hover:text-white transition",

    username: "text-gray-400 text-sm",
    ...
    return (
        <nav className={style.nav}>
            <div className={style.container}>
                ...
                {/* Mobile*/}
                <button onClick={toggleMenu} className={style.mobileButton}>
                    ☰
                </button>
            </div>
