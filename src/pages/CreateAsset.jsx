...
import { addAsset, setLoading } from "../store/slices/assetSlice";
...
const style = {
    ...
    title: "text-xl sm:text-2xl md:text-3xl font-bold mb-4 sm:mb-6 text-white",

    label: "block mb-1 font-medium text-gray-300 text-sm sm:text-base",

    input: "w-full bg-black border border-gray-700 text-white rounded-lg px-3 py-2 sm:px-4 sm:py-2.5 focus:outline-none focus:border-gray-500 text-sm sm:text-base",
    ...
    select: "bg-black border border-gray-700 text-white rounded-lg px-3 py-1.5 sm:px-3 sm:py-2 text-sm sm:text-base",
    ...
    browse: "text-white font-medium cursor-pointer hover:text-gray-300",

    previewLabel: "font-medium mb-2 text-white text-sm sm:text-base",

    remove: "text-gray-400 text-xs sm:text-sm mt-2 hover:text-white",
    ...
    progressText: "text-xs sm:text-sm text-gray-400 mt-2",
};
    ...
    return (
        <>
            ...
            <div className={style.wrapper}>
                <h2 className={style.title}>Upload New Asset</h2>
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                        <label className={style.label}>Visibility</label>
                    ...
                    >
                        ...
                        <p className="text-xs sm:text-sm mt-2">or</p>
